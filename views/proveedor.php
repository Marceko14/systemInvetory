              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title right-align">Proveedor <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                    ...
                    <div class="panel-body" style="text-align: right;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST" style="display: inline-block; text-align: left;">
